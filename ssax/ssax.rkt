...
(require "look-for-str.rkt")
(require "char-encoding.rkt")
...
(provide (all-from-out "look-for-str.rkt"))
(provide (all-from-out "char-encoding.rkt"))
(provide (all-from-out "SSAX-code.rkt"))
(provide (all-from-out "SXML-tree-trans.rkt"))
(provide (all-from-out "sxpathlib.rkt"))
(provide (all-from-out "srfi-12.rkt"))
(provide (all-from-out "mime.rkt"))
(provide (all-from-out "http.rkt"))
